...
-keep class com.android.music.ui.views.CustomMediaRouteActionProvider { *; }

# Custom Switch, referenced via menu action view class
-keep class com.android.music.ui.views.CustomSwitch { *; }
...
-keepnames class com.android.music.glide.utils.CustomGlideModule
-keep public class * implements com.bumptech.glide.module.GlideModule
...
-keep class com.android.music.http.itunes.** { *; }
-keep class com.android.music.http.lastfm.** { *; }
