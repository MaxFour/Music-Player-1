...
import com.android.music.glide.utils.GlideUtils;
import com.android.music.http.HttpServer;
import com.android.music.model.Album;
import com.android.music.model.Song;
import com.android.music.notifications.MusicNotificationHelper;
import com.android.music.rx.UnsafeAction;
import com.android.music.rx.UnsafeConsumer;
import com.android.music.services.Equalizer;
...
import com.android.music.utils.MediaButtonIntentReceiver;
...
public class MusicService extends Service {
    ...
    public static final String INTERNAL_INTENT_PREFIX = "com.android.music";
    ...
    public static final String SERVICE_COMMAND_PREFIX = "com.android.music.music_service_command";
    ...
    public interface ShortcutCommands {
        String PLAY = "com.android.music.shortcuts.PLAY";
        String SHUFFLE_ALL = "com.android.music.shortcuts.SHUFFLE";
        String FOLDERS = "com.android.music.shortcuts.FOLDERS";
        String PLAYLIST = "com.android.music.shortcuts.PLAYLIST";
    }
    ...
    void prepareChromeCastLoad(int position, boolean autoPlay) {
        ...
        metadata.addImage(new WebImage(Uri.parse("http://" + MPlayerUtils.getIpAddr() + ":5000" + "/image/" + getSongId())));

        MediaInfo selectedMedia = new MediaInfo.Builder("http://" + MPlayerUtils.getIpAddr() + ":5000" + "/audio/" + getSongId())
                .setStreamType(MediaInfo.STREAM_TYPE_BUFFERED)
                .setContentType("audio/*")
                .setMetadata(metadata)
                .build();

        if (MPlayerUtils.isUpgraded() && castManager != null) {
    ...
    private void setupMediaSession() {
        mediaSession = new MediaSessionCompat(this, "Music", mediaButtonReceiverComponent, null);
    ...
    public void onDestroy() {
        ...
        if (MPlayerUtils.hasJellyBeanMR2()) {
        ...
        if (what.equals(InternalIntents.TRACK_ENDING)) {
            ...
            if (finishedSong != null) {
                if (finishedSong.hasPlayed()) {
                    Completable.fromAction(() -> MPlayerUtils.incrementPlayCount(this, finishedSong)).subscribeOn(Schedulers.io())
                            .subscribe(() -> {
                                // Nothing to do
