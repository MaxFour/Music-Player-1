            ...
            switch (typeface) {
                ...
                case SANS_SERIF_MEDIUM:
                    if (MPlayerUtils.hasLollipop()) {
                        ...
                        result = Typeface.createFromAsset(MusicApplication.getInstance().getAssets(), "fonts/" + ROBOTO_MEDIUM);
                    }
                    break;
                case SANS_SERIF_LIGHT:
                    ...
                    break;
                default:
                    result = Typeface.createFromAsset(MusicApplication.getInstance().getAssets(), "fonts/" + typeface);
                    break;
            }
