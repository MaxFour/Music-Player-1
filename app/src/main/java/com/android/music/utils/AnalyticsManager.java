...
public class AnalyticsManager {
    ...
    public static void logChangelogViewed() {
        ...
        FirebaseAnalytics.getInstance(MusicApplication.getInstance())
    ...
    public static void logScreenName(Activity activity, String name) {
        ...
        FirebaseAnalytics.getInstance(MusicApplication.getInstance()).setCurrentScreen(activity, name, null);
    }
    ...
    public static void setIsUpgraded() {
        ...
        FirebaseAnalytics.getInstance(MusicApplication.getInstance()).setUserProperty("Upgraded", String.valueOf(MPlayerUtils.isUpgraded()));
    }
    ...
    public static void logInitialTheme(ThemeUtils.Theme theme) {
        ...
        FirebaseAnalytics.getInstance(MusicApplication.getInstance()).logEvent(FirebaseAnalytics.Event.VIEW_ITEM, params);
    }
