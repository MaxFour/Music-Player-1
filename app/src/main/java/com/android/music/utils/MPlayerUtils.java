...
public final class MPlayerUtils {

    //Arguments supplied to various bundles

    private final static String TAG = "MPlayerUtils";

    @NonNull
    public static Intent getMusicStoreIntent(@NonNull String packageName) {
        String uri;
        if (isAmazonBuild()) {
    ...
    @NonNull
    public static Intent getMusicWebIntent(@NonNull String packageName) {
        String uri;
        if (isAmazonBuild()) {
    ...
    public static void openMusicLink(@NonNull Activity activity, @NonNull String packageName, PackageManager packageManager) {
        Intent intent = getMusicStoreIntent(packageName);
        if (packageManager.resolveActivity(intent, 0) == null) {
            intent = getMusicWebIntent(packageName);
        }
            ...
            if (!Settings.System.canWrite(context)) {
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton(R.string.button_ok, (dialog, which) -> {
                            ...
                            intent.setData(Uri.parse("package:" + MusicApplication.getInstance().getPackageName()));
    ...
    public static boolean isOnline(boolean careAboutWifiOnly) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(MusicApplication.getInstance());
        ...
        final ConnectivityManager cm = (ConnectivityManager) MusicApplication.getInstance()
    ...
    public static boolean isUpgraded() {
        ...
        if (MusicApplication.getInstance().getIsUpgraded()) {
            return true;
        }
        ...
        try {
            return MusicApplication.getInstance().getPackageName().equals(Config.PACKAGE_NAME_PRO);
    ...
    public static boolean isLandscape() {
        final int orientation = MusicApplication.getInstance().getResources().getConfiguration().orientation;
        return orientation == Configuration.ORIENTATION_LANDSCAPE;
    }

    public static boolean isTablet() {
        return MusicApplication.getInstance().getResources().getBoolean(R.bool.isTablet);
    }
    ...
    public static String getIpAddr() {
        ...
        int i = ((WifiManager) MusicApplication.getInstance().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getIpAddress();
