...
public class PlaceholderProvider {
    ...
    private PlaceholderProvider() {
        final Resources res = MusicApplication.getInstance().getResources();
        ...
        Aesthetic.get(MusicApplication.getInstance()).isDark()
    ...
    public int getMediumPlaceHolderResId() {
        return R.drawable.ic_placeholder_light_medium;
    }

    @DrawableRes
    private int getLargePlaceHolderResId() {
        return R.drawable.ic_placeholder_light_large;
    }
    ...
    public Drawable getPlaceHolderDrawable(@Nullable String displayName, boolean large) {
        ...
        if (!TextUtils.isEmpty(displayName) && SettingsManager.getInstance().useGmailPlaceholders()) {
            ...
            drawable = ContextCompat.getDrawable(MusicApplication.getInstance(), large ? getLargePlaceHolderResId() : getMediumPlaceHolderResId());
        }
        return drawable;
    }
}
