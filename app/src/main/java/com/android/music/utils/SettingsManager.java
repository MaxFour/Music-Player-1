...
public class SettingsManager {
    ...
    private SharedPreferences getSharedPreferences() {
        return PreferenceManager.getDefaultSharedPreferences(MusicApplication.getInstance());
    }
    ...
    public int getAlbumDisplayType() {
        return getInt(KEY_ALBUM_DISPLAY_TYPE, MPlayerUtils.isTablet() ? ViewType.ALBUM_PALETTE : ViewType.ALBUM_LIST);
    }
    ...
    private String getArtistColumnCountKey() {
        ...
        if (MPlayerUtils.isLandscape()) {
            key = MPlayerUtils.isTablet() ? KEY_ARTIST_COLUMN_COUNT_TABLET_LAND : KEY_ARTIST_COLUMN_COUNT_LAND;
        } else {
            if (MPlayerUtils.isTablet()) key = KEY_ARTIST_COLUMN_COUNT_TABLET;
        }
    ...
    private String getAlbumColumnCountKey() {
        ...
        if (MPlayerUtils.isLandscape()) {
            key = MPlayerUtils.isTablet() ? KEY_ALBUM_COLUMN_COUNT_TABLET_LAND : KEY_ALBUM_COLUMN_COUNT_LAND;
        } else {
            if (MPlayerUtils.isTablet()) key = KEY_ALBUM_COLUMN_COUNT_TABLET;
        }
    ...
    public int getDefaultPageType() {
        return getInt(KEY_DEFAULT_PAGE, CategoryItem.Type.ALBUMS);
    }
