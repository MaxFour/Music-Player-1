...
import com.android.music.notifications.NotificationHelper;
...
public class ArtworkDownloadService extends Service {
    ...
    private static final String ACTION_CANCEL = "com.android.music.artwork_cancel";
    ...
    public void onCreate() {
        ...
        if (!MPlayerUtils.isOnline(false)) {
