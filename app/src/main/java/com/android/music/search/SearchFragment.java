...
import com.android.music.ui.detail.BaseDetailFragment;
...
import com.android.music.ui.modelviews.LoadingView;
...
public class SearchFragment extends BaseFragment implements
        com.android.music.search.SearchView,
    ...
    public void showToast(String message) {
        Toast.makeText(getContext(), (MusicApplication.getInstance().getString(R.string.emptyplaylist)), Toast.LENGTH_SHORT).show();
    }
