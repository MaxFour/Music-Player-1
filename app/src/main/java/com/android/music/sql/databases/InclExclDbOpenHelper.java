package com.android.music.sql.databases;
...
import com.android.music.sql.legacy.BlacklistDbOpenHelper;
import com.android.music.sql.legacy.BlacklistedSong;
import com.android.music.sql.legacy.LegacyDatabaseUtils;
import com.android.music.sql.legacy.WhitelistDbOpenHelper;
import com.android.music.sql.legacy.WhitelistFolder;
...
public class InclExclDbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        MusicApplication.getInstance().deleteDatabase(BlacklistDbOpenHelper.DATABASE_NAME);
        MusicApplication.getInstance().deleteDatabase(WhitelistDbOpenHelper.DATABASE_NAME);
    }
