package com.android.music.sql.legacy;
...
public class LegacyDatabaseUtils {
    ...
    public static BriteDatabase getBlacklistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new BlacklistDbOpenHelper(MusicApplication.getInstance()), Schedulers.io());
    }
    ...
    public static BriteDatabase getWhitelistDatabase() {
        return new SqlBrite.Builder().build()
                .wrapDatabaseHelper(new WhitelistDbOpenHelper(MusicApplication.getInstance()), Schedulers.io());
    }
