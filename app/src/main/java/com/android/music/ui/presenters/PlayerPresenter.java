...
public class PlayerPresenter extends Presenter<PlayerView> {
    ...
    public void bindView(@NonNull PlayerView view) {
        ...
        addDisposable(RxBroadcast.fromBroadcast(MusicApplication.getInstance(), filter)
