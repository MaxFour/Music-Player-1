...
import com.android.music.services.ArtworkDownloadService;
import com.android.music.ui.activities.BaseActivity;
import com.android.music.ui.dialog.ChangelogDialog;
import com.android.music.ui.dialog.InclExclDialog;
import com.android.music.ui.dialog.TabChooserDialog;
import com.android.music.ui.presenters.PurchasePresenter;
import com.android.music.utils.AnalyticsManager;
import com.android.music.utils.ColorPalette;
...
public class SettingsPresenter extends PurchasePresenter<SettingsView> {
        ...
        if (settingsView != null) {
            settingsView.showPrimaryColorDialog(
                    new ColorChooserDialog.Builder(context, R.string.pref_title_theme_pick_color)
                            ...
                            .allowUserColorInput(MPlayerUtils.isUpgraded())
    ...
    private void downloadArtwork(Context context) {
        ...
        MusicApplication.getInstance().startService(intent);
    }
    ...
    private void deleteArtwork() {
        ...
        Glide.get(MusicApplication.getInstance()).clearMemory();

        Completable.fromAction(() -> Glide.get(MusicApplication.getInstance()).clearDiskCache())
