...
import com.android.music.http.lastfm.LastFmAlbum;
import com.android.music.http.lastfm.LastFmArtist;
import com.android.music.model.FileObject;
import com.android.music.model.Song;
import com.android.music.utils.DialogUtils;
...
import static com.android.music.R.id.album;
import static com.android.music.R.id.artist;
...
public class BiographyDialog {
    ...
    public static void showFileInfoDialog(Context context, FileObject fileObject) {
        ...
        bitrateKey.setText(R.string.song_info_bitrate);
        TextView bitrateValue = bitrateView.findViewById(R.id.value);
        bitrateValue.setText(fileObject.tagInfo.bitrate + MusicApplication.getInstance().getString(R.string.song_info_bitrate_suffix));

        View samplingRateView = view.findViewById(R.id.sample_rate);
        TextView samplingRateKey = samplingRateView.findViewById(R.id.key);
        samplingRateKey.setText(R.string.song_info_sample_Rate);
        TextView samplingRateValue = samplingRateView.findViewById(R.id.value);
        samplingRateValue.setText(fileObject.tagInfo.sampleRate / 1000 + MusicApplication.getInstance().getString(R.string.song_info_sample_rate_suffix));
