...
import com.android.music.ui.activities.BaseCastActivity;
import com.android.music.ui.views.CustomMediaRouteActionProvider;
...
public abstract class BaseFragment extends BaseController {
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        RefWatcher refWatcher = MusicApplication.getInstance().getRefWatcher();
