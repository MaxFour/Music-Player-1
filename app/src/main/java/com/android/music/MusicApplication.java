...
import com.android.music.dagger.component.AppComponent;
import com.android.music.dagger.component.DaggerAppComponent;
...
import com.android.music.utils.InputMethodManagerLeaks;
import com.android.music.utils.LegacyUtils;
...
public class MusicApplication extends Application {
    ...
    public void onCreate() {
        ...
        Completable.fromAction(() -> {
            ...
            SqlUtils.createActionableQuery(MusicApplication.this, cursor ->
    ...
    protected AppComponent initDagger(MusicApplication application) {
    ...
    private Observable<List<Song>> cleanGenres() {
        ...
        return SqlBriteUtils.createSingleList(MusicApplication.getInstance(), Genre::new, Genre.getQuery())
